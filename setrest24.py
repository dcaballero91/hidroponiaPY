...
Ej. llamada:
http://192.168.137.220/scrapgin/setrest24 por apache
http://192.168.137.107:5000/setrest24 por flask
{
	"mod":"uv"
}
...
setrest24 = Blueprint('setrest24', __name__)

@setrest24.route('/setrest24', methods=['POST'])
